import { Price } from '@/domain/value_object/price.vo';
import { Stock } from '@/domain/value_object/stock.vo';
import { InsufficientStockException } from '../errors/insufficient-stock.error';
export class Item {
